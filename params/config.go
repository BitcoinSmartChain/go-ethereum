...
var (
	MainnetGenesisHash = common.HexToHash("0xd7d18f7c51ab75059ddfb70fa88408ba53f94378339d185899c5819b1a3d5c98")
...
type ChainConfig struct {
	...
	Ichain *IchainConfig `json:"ichain,omitempty"`

	Ethash *EthashConfig `json:"ethash,omitempty"`
	Clique *CliqueConfig `json:"clique,omitempty"`
}

// IchainConfig is the consensus engine configs for proof-of-inter-chain based sealing.
...
func (c *ChainConfig) Description() string {
	...
	case c.Ichain != nil:
		banner += "Consensus: IChain (proof-of-inter-chain)\n"
	default:
